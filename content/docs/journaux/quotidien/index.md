...
avec qui cette personne est en relation, quel est son contexte, ses préoccupations, ses désirs.
...
Nous savons que notre mémoire n'est pas un témoin fiable, et que les mémoires sont altérées chaque fois qu'elles sont rappelées.
Un support écrit est plus qu'un outil, c'est un service rendu à mon futur moi.
Cela me protège contre les mensonges et les omissions que je me fais à moi-même
parce que j'observe un peu plus objectivement mes habitudes.
Je suis également protégé contre les manipulations, les mensonges et les déformations de faits volontaires ou non par les autres.
...
Le quadrillé permet d'aligner verticalement les paragraphes avec une marge à gauche pour les mots-clés.
De plus, la hauteur des lignes est plus petite que le Notebook traditionnel, ce qui augmente la densité de l'information.
...
* Une entête pour chaque jour: « aaaa-mm-jj Jour_de_la_semaine »
* Un mot-clé ou un nom propre pour chaque entrée.
